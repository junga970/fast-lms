...
public class MemberController {
    ...
    @RequestMapping("/member/history_save")
    public String history_save(HttpServletRequest request, Authentication authentication) {

        memberService.history_save(request, authentication);
